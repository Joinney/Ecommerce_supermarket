...
const ProductCard = ({ p }) => (
  <div className="flex-shrink-0 w-[170px] md:w-[210px] group cursor-pointer font-sans bg-white p-2 rounded-[32px] hover:shadow-2xl hover:shadow-slate-100 transition-all duration-500 border border-transparent hover:border-slate-50">
